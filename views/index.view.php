<div class="container-fluid p-0 h-100">
    <div class="text-center bg-danger <?php if(!isset($_GET['err'])){echo 'd-none';} ?>"><p style="font-size: 2rem;">Ubicación sin resultados</p></div>
...
<div class="fondoNegro">
    <div class="container-fluid my-3 p-0 px-2">
